...
following default options adds entry to file:~/.bashrc and installs ghcup and
cabal
...
** extension to make Haskell strict by default
https://downloads.haskell.org/ghc/latest/docs/users_guide/exts/strict.html#strict-by-default-pattern-bindings
