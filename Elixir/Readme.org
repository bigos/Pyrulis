...
This is the initial attempt to experiment with Elixir. Later I found [[*Installing on Linux with asdf][asdf]] to be much better.
...
now create the folder in file:~/Programming/Elixir/
#+begin_example
  mkdir ./second
